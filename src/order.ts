 ...
 * @private
 */
function typeOrder(val: api.Value): TypeOrder {
 ...
 * @private
 */
function compareNumberProtos(left: api.Value, right: api.Value): number {
 ...
 * @private
 */
function compareBlobs(left: Buffer, right: Buffer): number {
 ...
 * @private
 */
function compareReferenceProtos(left: api.Value, right: api.Value): number {
  assert(
 ...
 * @private
 */
function compareArrays(left: api.Value[], right: api.Value[]): number {
 ...
 * @private
 */
function compareObjects(left, right): number {
